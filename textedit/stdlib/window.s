...
; ---------------------------------------------------------------
; void __near__ set_keyboard_handler (void *func)
; ---------------------------------------------------------------

.segment	"CODE"

.proc	_set_keyboard_handler: near

.segment	"CODE"

	jsr     pushax
	jsr     ldax0sp
	sta     _keyboard_handler
	stx     _keyboard_handler+1
	jmp     incsp2
...
L000B:	jsr     ldax0sp
	...
	jmp     L0012
L0008:	lda     _last_window_element+1
	sta     ptr1+1
	lda     _last_window_element
	sta     ptr1
	jsr     ldax0sp
...
; ---------------------------------------------------------------
; void __near__ catch_keyboard (void)
; ---------------------------------------------------------------

.segment	"CODE"

.proc	_catch_keyboard: near

.segment	"CODE"

	jsr     decsp1
	jmp     L0007
L0002:	lda     _input_buf
	ldx     _input_buf+1
	...
	and     #$80
	bne     L0007
	lda     _keyboard_handler
	ldx     _keyboard_handler+1
	jsr     pushax
	ldy     #$02
	ldx     #$00
	lda     (sp),y
	...
	jsr     jmpvec
	jsr     incsp2
L0007:	lda     _input_buf_read_ptr
	jsr     pusha0
	lda     _input_buf_write_ptr+1
	sta     ptr1+1
